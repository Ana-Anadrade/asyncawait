...
import 'package:funcionesasync/services/mockapi.dart';
        ...
        child: Center(
          child: Column(
            ...
            children: <Widget>[
              ...
              _buildCircularButton(1, Icons.laptop, 'Button 1', Colors.green),
              Text('${_counters[1] ?? 0}', style: TextStyle(color: Colors.green, fontSize: 24)),
              _buildCircularButton(2, Icons.tablet_android, 'Button 2', const Color.fromARGB(255, 17, 0, 255)),
              Text('${_counters[2] ?? 0}', style: TextStyle(color: const Color.fromARGB(255, 17, 0, 255), fontSize: 24)),
              _buildCircularButton(3, Icons.phone_android, 'Button 3', Colors.red),
  ...
  return Column(
    children: [
      ...
      FractionallySizedBox(
        widthFactor: 0.4, // Modifica este valor para ajustar el ancho de la barra de progreso
        child: LinearProgressIndicator(
          value: _counters[buttonIndex] != null
              ? _counters[buttonIndex]! / 100 // Aquí ajusta el valor máximo según tu caso
              : null,
